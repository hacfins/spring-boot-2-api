package com.langyastudio.edu.admin.common.data;
...
public class Define extends BasDefine
{
    ...
    //直播类型
    public final static String LIVE_NOW   = "1";
    public final static String LIVE_WILL  = "2";
    public final static String LIVE_OVER  = "3";
    public final static String LIVE_ALL   = "4";
