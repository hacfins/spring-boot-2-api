...
public class RedisT
{
    ...
    public RedisT(RedisTemplate<String, Object> redisTemplate)
    {
    ...
    {
        return key == null ? null : (JSON.parseObject((String) (redisTemplate.opsForValue().get(key)), clazz));
    }
    ...
    {
        return key == null ? null : (JSON.parseObject((String) (redisTemplate.opsForValue().get(key)), String.class));
    }
     ...
     * @return 成功个数
     */
    public long setAnd(String key, long time, Object... values)
    {
        try
        {
     ...
     * @return
     */
    public boolean listSetAll(String key, List<Object> value)
    {
        try
        {
     ...
     * @return
     */
    public boolean listSetAll(String key, List<Object> value, long time)
    {
        try
        {
            redisTemplate.opsForList().rightPushAll(key, value);
     ...
     * @param values  待添加的数据
     */
    public void addToListRight(String listKey, Long time, TimeUnit var3, Object... values)
    {
        //绑定操作
        ...
        //设置过期时间
        boundValueOperations.expire(time, var3);
    }
